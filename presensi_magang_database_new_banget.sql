...
-- Events
--
CREATE DEFINER=`root`@`localhost` EVENT `update_status_daily` ON SCHEDULE EVERY 1 DAY STARTS '2024-02-12 07:40:00' ON COMPLETION NOT PRESERVE ENABLE DO UPDATE peserta_magangs
    SET status_aktif = 
        CASE
            WHEN tanggal_selesai < CURDATE() THEN 1
            WHEN CURDATE() BETWEEN tanggal_mulai AND tanggal_selesai THEN 2
            WHEN tanggal_mulai > CURDATE() THEN 3
        END$$
